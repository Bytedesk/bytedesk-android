...
- [Demo](https://gitee.com/270580156/bytedesk-android/blob/master/Tutorial/feedback)
...
- 获取subDomain，也即企业号：登录后台->客服->账号->企业号管理->技能组 添加技能组，并可将客服账号添加到相关技能组。注意：生成记录中有一列 ‘唯一ID（wId）’ 会在工作组会话中用到
