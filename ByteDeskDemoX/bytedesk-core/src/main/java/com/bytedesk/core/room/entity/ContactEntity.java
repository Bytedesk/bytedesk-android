...
@Entity(tableName = "contact", indices = {@Index("current_uid")})
public class ContactEntity {
     ...
     * 昵称拼音首字母，大写
     */
    @ColumnInfo(name = "pinyin_cap_nickname")
    private String pinyinCapNickname;

    /**
     * 真名拼音首字母，大写
     */
    @ColumnInfo(name = "pinyin_cap_realname")
    ...
    public String getPinyinCapNickname() {
        return pinyinCapNickname;
    }

    public void setPinyinCapNickname(String pinyinCapNickname) {
        this.pinyinCapNickname = pinyinCapNickname;
    }

    public String getPinyinCapRealname() {
        return pinyinCapRealname;
    }

    public void setPinyinCapRealname(String pinyinCapRealname) {
        this.pinyinCapRealname = pinyinCapRealname;
    }
}
