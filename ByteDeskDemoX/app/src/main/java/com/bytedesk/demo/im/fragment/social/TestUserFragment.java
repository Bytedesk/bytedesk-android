 ...
 *
 */
public class TestUserFragment extends BaseFragment implements SwipeItemClickListener {
    ...
    protected View onCreateView() {
        View root = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_test_user, null);
