 ...
 *
 */
public class FanFragment extends BaseFragment implements SwipeItemClickListener {
    ...
    protected View onCreateView() {
        View root = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_fan, null);
    ...
    private void getFans() {
        ...
        BDCoreApi.getFans(getContext(), 0, 20, new BaseCallback() {
