...
public class MqttAndroidClient extends BroadcastReceiver implements IMqttAsyncClient {
	...
	/**
	 * 1. 在manifest.xml文件里面添加service
	 * 2. 修改包名的时候，需要一同修改
	 */
	private static final String SERVICE_NAME = "com.bytedesk.paho.android.service.MqttService";
	 ...
	 * @param serverURI
	 *            specifies the protocol, SHORT_LINK_HOST name and port to be used to
	 *            login to an MQTT server
	 * @param clientId
	 ...
	 * @return token used to track and wait for the login to complete. The
	...
	/**
	 * Connects to an MQTT server using the provided login options.
	 * <p>
	 ...
	 *            if not required.
	 * @param callback
	 *            optional listener that will be notified when the login
	 ...
	 * <p>
	 * The server to login to is specified on the constructor. It is
	 ...
	 *
	 * <p>
	 * The method returns control before the login completes. Completion can
	 * be tracked by:
     * </p>
	 * <ul>
...
//			FIXME:  java.lang.IllegalStateException: Not allowed to start service Intent
...
//			}
	...
	/**
	 * Actually do the mqtt login operation
	 */
	...
	public IMqttToken subscribe(String topic, int qos, Object userContext,
		...
		// null check added by jackning, 20190118
		if (null != mqttService) {
	 ...
	 * state to be remembered the client must login with cleanSession set to
	 * false
	 * </P>
	 * 
	 ...
	 * login and subscribe can be tracked using the {@link MqttToken} returned
	...
	private void connectExtendedAction(Bundle data){
		// This is called differently from a normal login
	 ...
	 *            is generated
	 * @return SSLSocketFactory used to login to the server with SSL
	 *         authentication
	 * @throws MqttSecurityException
