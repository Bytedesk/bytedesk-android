 ...
 */
package com.bytedesk.im.ui.widget;
...
import com.bytedesk.im.ui.util.ServiceUtil;
...
public class KeyboardAwareLinearLayout extends LinearLayoutCompat {
    ...
    public KeyboardAwareLinearLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        minKeyboardSize = getResources().getDimensionPixelSize(R.dimen.bytedesk_min_keyboard_size);
        minCustomKeyboardSize = getResources().getDimensionPixelSize(R.dimen.bytedesk_min_custom_keyboard_size);
        defaultCustomKeyboardSize = getResources().getDimensionPixelSize(R.dimen.bytedesk_default_custom_keyboard_size);
        minCustomKeyboardTopMargin = getResources().getDimensionPixelSize(R.dimen.bytedesk_min_custom_keyboard_top_margin);
