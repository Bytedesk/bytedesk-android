package com.bytedesk.im.ui.util;
...
public class EmotionMapsContact {
	...
	public EmotionMapsContact(Context context) {
		m_context = context;
...
//		m_emotionViewPagerGridView1.setOnItemClickListener((ChatIMContactActivity)m_context);

		m_emotionViewPagerGridView2.setAdapter(m_emotionViewPagerGridView2Adapter);
//		m_emotionViewPagerGridView2.setOnItemClickListener((ChatIMContactActivity)m_context);

		m_emotionViewPagerGridView3.setAdapter(m_emotionViewPagerGridView3Adapter);
//		m_emotionViewPagerGridView3.setOnItemClickListener((ChatIMContactActivity)m_context);

		m_emotionViewPagerGridView4.setAdapter(m_emotionViewPagerGridView4Adapter);
//		m_emotionViewPagerGridView4.setOnItemClickListener((ChatIMContactActivity)m_context);

		m_emotionViewPagerGridView5.setAdapter(m_emotionViewPagerGridView5Adapter);
//		m_emotionViewPagerGridView5.setOnItemClickListener((ChatIMContactActivity)m_context);
