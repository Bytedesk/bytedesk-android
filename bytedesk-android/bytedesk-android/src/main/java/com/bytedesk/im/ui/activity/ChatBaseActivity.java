...
import com.bytedesk.im.core.event.KickoffEvent;
import com.bytedesk.im.core.event.LongClickEvent;
import com.bytedesk.im.core.event.MessageEvent;
...
public class ChatBaseActivity extends AppCompatActivity {
    ...
    // 客服会话代表会话uid，一对一会话代表uid，群组会话代表gid
...
////                        BDMqttApi.sendReceiptReadMessage(this, mid, uid);
//                    }
//                }
//            } else {
//                Logger.i(" uid != mUUID");
