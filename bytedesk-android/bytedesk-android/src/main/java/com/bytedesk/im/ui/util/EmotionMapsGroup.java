...
public class EmotionMapsGroup {
	...
	public EmotionMapsGroup(Context context) {
		m_context = context;
...
//		m_emotionViewPagerGridView1.setOnItemClickListener((ChatIMGroupActivity)m_context);

		m_emotionViewPagerGridView2.setAdapter(m_emotionViewPagerGridView2Adapter);
//		m_emotionViewPagerGridView2.setOnItemClickListener((ChatIMGroupActivity)m_context);

		m_emotionViewPagerGridView3.setAdapter(m_emotionViewPagerGridView3Adapter);
//		m_emotionViewPagerGridView3.setOnItemClickListener((ChatIMGroupActivity)m_context);

		m_emotionViewPagerGridView4.setAdapter(m_emotionViewPagerGridView4Adapter);
//		m_emotionViewPagerGridView4.setOnItemClickListener((ChatIMGroupActivity)m_context);

		m_emotionViewPagerGridView5.setAdapter(m_emotionViewPagerGridView5Adapter);
//		m_emotionViewPagerGridView5.setOnItemClickListener((ChatIMGroupActivity)m_context);
