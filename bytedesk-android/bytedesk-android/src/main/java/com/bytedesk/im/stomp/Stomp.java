...
import com.bytedesk.im.stomp.provider.OkHttpConnectionProvider;
import com.bytedesk.im.stomp.provider.WebSocketsConnectionProvider;
...
public class Stomp {
    ...
    private static StompClient createStompClient(com.bytedesk.im.stomp.provider.ConnectionProvider connectionProvider) {
